...
public interface ResultRepository extends JpaRepository<Result, Long> {
    ...
    @Query(value = "select new com.example.demo.model.Output(r.cname as coursename,r.dname as deptname,avg(r.average) as overallaverage) from Result r where r.dname=?1 group by r.cname,r.dname")
    public List<Output> groupBy(@Param("dname") String dname);
    ...
    @Query(value="select new com.example.demo.model.DeptReport(r.cname as bestcourse,r.dname as bestdept,max(r.average) as totalscore) from Result r where r.dname =?1 group by r.dname")
    List<DeptReport> bestcourseindept(@Param("dname") String dname);
